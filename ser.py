...
while(1):
    ...
    if(len(hrValues)==1000):
            ...
            HrResultado_1 = analisisHR(hrValues, miliValues, 6)
            ...
            try:
                ...
                cnx = mysql.connector.connect(user='root', password='Guerra11', host='127.0.0.1', database='covidDetector', auth_plugin='mysql_native_password')
                cursor = cnx.cursor()
                ...
                hora = datetime.time()
                queryPulso = (persona, idPulso, fecha, hora, HrResultado_1)
